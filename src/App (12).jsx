...
export default function App() {
  ...
  // PARAMETRES
  if (showParametres) return (
    <div style={styles.app}>
      <div style={{ ...styles.header, position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <button onClick={() => setShowParametres(false)} style={{ position: "absolute", left: 12, background: "none", border: "none", color: GOLD, cursor: "pointer", fontSize: 28 }}>‹</button>
        <img src="/logo.png" alt="PEPIT'" style={{ width: 50, height: "auto", background: "white", borderRadius: 8, padding: 4 }} />
      </div>
      <div style={styles.content}>
        ...
        <div style={styles.card}>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#333", marginBottom: 8 }}>Notifications</div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 13 }}>
            <span>Recevoir les offres spéciales</span>
            <div style={{ width: 40, height: 22, background: GOLD, borderRadius: 11, cursor: "pointer", position: "relative" }}>
        ...
        <div style={{ padding: "12px", background: "#fff5f5", borderRadius: 10, border: "1px solid #f8d7da" }}>
          ...
          <div style={{ fontSize: 12, color: "#721c24", marginBottom: 10, lineHeight: 1.6 }}>
            En résiliant, vous perdrez l'accès à tous les avantages PEPIT' à la fin de votre période en cours. Cette action est irréversible.
          </div>
        ...
        <div style={{ fontSize: 11, color: "#aaa", textAlign: "center" }}>
          PEPIT' SAS — Version 1.0<br />
          Contact : contact@pepit.gp
        </div>
      </div>
    </div>
  );

...
export default function App() {
  ...
  async function doSignup() {
    ...
    try {
      ...
      setSuccess("✅ Compte créé ! Un email de confirmation a été envoyé à " + signupEmail + ". Pensez à vérifier vos spams. Vous allez être redirigé vers le paiement...");
      setTimeout(() => { window.location.href = checkoutUrl; }, 4000);
